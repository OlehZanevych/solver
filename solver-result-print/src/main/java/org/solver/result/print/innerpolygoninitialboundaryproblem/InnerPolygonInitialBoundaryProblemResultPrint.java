package org.solver.result.print.innerpolygoninitialboundaryproblem;
...
@Component("innerPolygonInitialBoundaryProblemResultPrint")
public class InnerPolygonInitialBoundaryProblemResultPrint implements ResultPrint<InnerPolygonInitialBoundaryProblemOutput> {

	public void print(final InnerPolygonInitialBoundaryProblemOutput output, final String outputFileName) {
